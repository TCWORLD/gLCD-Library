	...
	*/
	...
	class gLCD {
		...
		private:
			...
			//void FdigitalWrite(byte regValue, boolean bitValue, boolean port); //port = _CS_PORT, (replacing CS with the name of the pin) (ports B and D only)
																						//regValue = _CS_HIGH, or CS_LOW, (replacing CS with right pin)
																						//bitValue = 1 (HIGH), or 0 (LOW)
