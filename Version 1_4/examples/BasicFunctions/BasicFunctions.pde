...
void setup() {
 /*If you can't see the colours properly, then uncomment the 
   ...
   the different colours distinctly on the test pattern, send a value <0x2B (<0x30 for Phillips). 
   
   The default values should work for many screens, so you may not need to call this at all.
 */
